...
/********************************************************************************************
* Function:    globalfifo_poll
* Description: globalfifo poll
* Input:       filp: struct file
*              poll_table: poll table pointer
* Output:      None
* Return:      unsigned int: function mask
* Others:      
* Revision history:
             1.Date:     2022-1-24
               Author:   JexJiang
...
/********************************************************************************************
* Function:    globalfifo_fasync
* Description: globalfifo fasync
